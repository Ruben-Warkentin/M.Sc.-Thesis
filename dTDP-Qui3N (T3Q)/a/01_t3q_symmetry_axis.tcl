...
set outfile_v1 [open symmetry_axis_v1.txt w]
set outfile_v2 [open symmetry_axis_v2.txt w]
set outfile_v3 [open symmetry_axis_v3.txt w]
#write into the outfile, there are headings
puts $outfile_v1 "symmetry_v1 x_y_z"
puts $outfile_v2 "symmetry_v2 x_y_z"
puts $outfile_v3 "symmetry_v3 x_y_z"
#create a loop
