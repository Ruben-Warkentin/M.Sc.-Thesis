...
# min θ: 76.85429378218016   max θ: 186.3518106530784
...
# min θ: 1.4198717757599817   max θ: 358.27975697706717
# min z: -20.614926325812093   max z: 21.150335974853164

# but the lower z-extent of the whole molecule is about -29.2 Å, and the upper extent is about 28.7 Å.
# Let us assume we want to approch the backbone down to r = 6.3 Å
# Initially, we can bring each carbohydrate molecule from r = 25 Å inward, to have a total trip of 18.7 Å per simulation.
...
# To be conservative, let us require that at r = 6.3*2 = 12.6 Å, we should have "full coverage", i.e., enough many carbohydrate probes
# that fully mosaic-cover the cylinder with r = 12.6 Å.
# Here is that cylinder:
draw color green
draw cylinder {0 0 -29.2}  {0 0 28.7} radius 12.6 resolution 300
# The surface area to cover is thus: A = 2πrh = 2π * 12.6 * (29.2+28.7) = 4584 Å^2
...
# surface area of 49 Å^2. The number of simulation boxes is thus 4584/49 ≈ 94 boxes.
# The circumferance of the base of the cylinder at r = 12.6 Å is about 79 Å, whereas 
# the height of the cylinder is about 57.9 Å. So we need ~1.36 as many "mosaics"
