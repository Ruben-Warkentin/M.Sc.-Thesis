...
for {set i 0} {$i < [llength $zz]} { incr i }  {
	for {set j 0} {$j < [llength $thetas]} {incr j}	{
        ...
        set psfFile "configurations/$z\_$theta/MtDARPin\_\_T3Q\_$z\_$theta\_\_solvated\_ionized";
        set dcdFile "configurations/$z\_$theta/o/MtDARPin\_\_T3Q\_$z\_$theta_dcd";
        mol new $psfFile.psf
        mol addfile $dcdFile.dcd waitfor all
        hbonds -sel1 [atomselect top "segid MT"] -sel2 [atomselect top "segid T3Q"] -outdir configurations/$z\_$theta/  -writefile yes -type all
        mol delete all;
        }
    }
