...
# 2XEE DARPin vs 96 T3Q molecules, arranged around it. -- SMD

#############################################################
## ADJUSTABLE PARAMETERS                                   ##
#############################################################
set xscFile [glob "2XEE\_\_T3Q\_*\_\_solvated\_ionized.xsc"];
set psfFile [glob "2XEE\_\_T3Q\_*\_\_solvated\_ionized.psf"];
set pdbFile [glob "2XEE\_\_T3Q\_*\_\_solvated\_ionized.pdb"];
...
structure              		$psfFile
coordinates        			$pdbFile
outputName        			"o/2XEE\_\_T3Q\_$z\_$theta"
...
set dt 0.000002;
set v 20; # drift velocity of the ligand waist in Å/ns.
...
set r0 25;
set n_first 2367;     # First atom of the sugar molecule
set n_last 2426;      # Last atom of the sugar molecule
