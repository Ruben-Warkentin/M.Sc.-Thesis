...
mol new 2XEE_T3Q.psf;
mol addfile 2XEE_T3Q.pdb;
...
$all set beta 0
$all set occupancy 0
set darpin [atomselect top "segid 2XEE"]
...
for {set i 0} {$i < [llength $zz]} { incr i }  {
	for {set j 0} {$j < [llength $thetas]} {incr j}	{
		...
		$all writepdb "configurations/$z\_$theta/2XEE__T3Q_$z\_$theta.pdb";
		$all writepsf "configurations/$z\_$theta/2XEE__T3Q_$z\_$theta.psf";
		}
}
