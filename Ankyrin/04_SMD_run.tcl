...
# 4XCZ ankyrin vs  80 T3Q molecules, arranged around it. -- SMD

#############################################################
## ADJUSTABLE PARAMETERS                                   ##
#############################################################
set xscFile [glob "4XCZ\_\_T3Q\_*\_\_solvated\_ionized.xsc"];
set psfFile [glob "4XCZ\_\_T3Q\_*\_\_solvated\_ionized.psf"];
set pdbFile [glob "4XCZ\_\_T3Q\_*\_\_solvated\_ionized.pdb"];
...
structure              		$psfFile
coordinates        			$pdbFile
outputName        			"o/4XCZ\_\_T3Q\_$z\_$theta"
...
if {0} {
cellBasisVector1     150.00  		    0.0		   			0.0
cellBasisVector2     0.0   				150.00   			0.0
cellBasisVector3     0.0				0.0					150.00
cellOrigin           0.03965905013949352 0.8784711582456017 1.9201951068088667
}
wrapWater           on
wrapAll             on
...
set tau  50100;  # Number of Time-steps spent at rest before force is applied
set k 1 ; #Spring constant for peptide molecule in Kcal/(mol.Å^2)
set r0 25;
set n_first 2084;     # First atom of the sugar molecule
set n_last 2143;      # Last atom of the sugar molecule
